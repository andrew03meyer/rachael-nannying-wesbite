function Banner(){
    return (
        ...
        <div className="flex justify-center h-20 w-full bg-gradient-to-b from-white via-orange-100 to-orange-100 font-roboto text-md italic items-center p-2 text-white">
