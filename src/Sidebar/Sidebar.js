...
function Sidebar(){
    return(
    <ul className ="group space-y-1 h-screen w-20 hover:w-1/6 transition-all duration-1000">
        ...
        <li className="">
            <Link to="/" className="group-hover:block hidden truncate rounded-lg px-4 py-2 text-sm font-medium text-gray-500 bg-grey-100 hover:bg-gray-100 hover:text-gray-700">
            Home
            </Link>
        </li>
        ...
        <li>
            <Link to="/rates" className="group-hover:block hidden truncate rounded-lg px-4 py-2 text-sm font-medium text-gray-500 hover:bg-gray-100 hover:text-gray-700">
            Rates
            </Link>
        </li>
    </ul>
