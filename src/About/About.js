...
function About() {
  return (
    ...
    <div className="flex flex-col items-center relative w-screen h-auto">
        ...
        <h2 className="absolute text-7xl text-center mt-20 font-serif font-bold text-orange-300">About Me:</h2>

        <div className="relative p-5 bg-gradient-to-r from-orange-100 to-orange-200 font-serif m-5 shadow-2xl rounded-3xl w-full">
