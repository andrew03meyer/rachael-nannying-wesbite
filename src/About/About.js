...
function About() {
  return (
    ...
    <div className="flex flex-col items-center relative w-screen h-auto mb-52">
      <TopBanner />
        <div className="max-h-[600px] overflow-y-hidden rounded-3xl mb-10">
        ...
        <div className="relative flex flex-col p-5 font-roboto w-full">
          ...
          <div className="flex">
            ...
            <div className="flex flex-col items-center m-2 p-5 rounded-3xl bg-gradient-to-br from-gray-50 to-gray-100">
        ...
        <div className="relative p-5 bg-gradient-to-br from-gray-50 to-gray-100 font-roboto w-full">
